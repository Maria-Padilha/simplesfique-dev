                      ...
                      <template #resultados="{ selecionar }">
                        ...
                        >
                          <template #default="{ item }">
                            ...
                            >
                              <p class="text-body-1">({{ item.id }}) - {{ item.apelido_fantasia || item.nome_razao || item.nome }}</p>
                            </div>
                          </template>
                        </v-virtual-scroll>
                      </template>
...
const statusOptions = [
  { title: 'Todas', value: '' },
  { title: 'Não Baixadas', value: 'N' },
  { title: 'Baixadas', value: 'S' },
  { title: 'Canceladas', value: 'C' }
]

// Computed para validar campos obrigatórios
...
// Computed para contar quantos filtros estão ativos
...
watch(() => props.modelValue, (newVal) => {
  Object.assign(filtrosLocal, newVal)
