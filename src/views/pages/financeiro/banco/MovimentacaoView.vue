<template>
  <top-all-pages icon="mdi-bank-transfer">
    ...
    <template #section>
      <div>
        <!-- Conteúdo Principal -->
        <v-card :color="themeStore.darkMode ? 'text-white' : ''" class="background-secondary pa-3" elevation="0">
        ...
        <v-card class="background-secondary mt-2 py-3 px-3 d-flex gap-4" elevation="0">
